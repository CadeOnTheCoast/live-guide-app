        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="max-w-2xl">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="max-h-[70vh] overflow-y-auto pr-6 -mr-6 py-4 space-y-4">
                        ...
                        <div className="space-y-1">
                            ...
                            <Textarea id="notes" name="notes" defaultValue={decisionMaker?.notes ?? ""} rows={2} />
                        </div>

                        <div className="border-t pt-4 bg-muted/20 p-4 rounded-lg">
                            <p className="text-xs font-bold uppercase tracking-widest text-brand-teal mb-3">Detailed Strategic Data</p>
                            <div className="space-y-3">
                                <div className="space-y-1">
                                    <Label htmlFor="reason">Strategic Reason (Why are they on the board?)</Label>
                                    <Textarea id="reason" name="reason" defaultValue={decisionMaker?.reason ?? ""} placeholder="e.g. Primary permitting authority for..." rows={2} />
                                </div>
                                <div className="space-y-1">
